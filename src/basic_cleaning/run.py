...
def go(args):
    ...
    # Drop coordinates outliers (to ensure geolocation checks pass)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact",
        type=str,
        help="Input raw data artifact in W&B",
        required=True
    )
    parser.add_argument(
        "--output_artifact",
    ...
    parser.add_argument(
        "--min_price",
        type=float,
        help="Minimum price filter boundary",
        required=True
    )
    parser.add_argument(
        "--max_price",
        type=float,
        help="Maximum price filter boundary",
        required=True
    )
